class IssueModal {
  constructor() {
    ...
    this.confirmHeading = "Are you sure you want to delete this issue?";
    this.confirmText = "Once you delete, it's gone for good";
  }
  ...
  validateExpectedAmountIssues(amountOfIssues) {
  ...
  confirmDeletion() {
    cy.get(this.confirmationPopup).within(() => {
      cy.contains(this.confirmHeading).should("be.visible");
      cy.contains(this.confirmText).should("be.visible");
